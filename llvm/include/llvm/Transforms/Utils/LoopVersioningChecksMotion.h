...
#ifndef LLVM_TRANSFORMS_UTILS_LOOPVERSIONINGCHECKSMOTION
#define LLVM_TRANSFORMS_UTILS_LOOPVERSIONINGCHECKSMOTION
...
namespace llvm {
class LoopVersioningChecksMotionPass
    : public PassInfoMixin<LoopVersioningChecksMotionPass> {
private:
